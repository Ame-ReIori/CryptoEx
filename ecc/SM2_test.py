...
if __name__ == "__main__":
    ...
    gy = 2
    '''
    pt = open(r'E:\CryptoCode\CodeInPython\Experiment8\SM2_KEY\Message.txt', 'r')
    sk = open(r'E:\CryptoCode\CodeInPython\Experiment8\SM2_KEY\PrivateKey.txt', 'w')
    pk = open(r'E:\CryptoCode\CodeInPython\Experiment8\SM2_KEY\PublicKey.txt', 'w')

    cfile = open(
        r'E:\CryptoCode\CodeInPython\Experiment8\SM2_KEY\Ciphertext.txt', 'w')
    mfile = open(
        r'E:\CryptoCode\CodeInPython\Experiment8\SM2_KEY\MessageDecrypted.txt', 'w')
    label1 = '------------------------------------Public Key------------------------------------\n'
    ...
    c = SM_2.Encrypt(pka, m)
    cfile.write(c)
    m1 = SM_2.Decrypt(ska, c)
    
    mfile.write(strtools.hex_to_chr(m1))
